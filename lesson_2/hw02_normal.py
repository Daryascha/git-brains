...
for item in one:
    if int(item) < 0:
        continue
    elif int(item) > 0 and math.sqrt(int(item))%1 == 0:
        new.append(math.sqrt(int(item)))
print (new)
...
data = input('введите дату в формате 01.01.1990 на английской раскладке ')
data_list = data.split('.')
dict_months = {'01': 'января', '02': 'феврал', '03': 'марта', '04': 'апреля', '05': 'мая', '06': 'июня',
'07': 'июля', '08': 'августа', '09': 'сентября', '10': 'октября', '11': 'ноября', '12': 'декабря'}
dict_days = {'01': 'первое', '02': 'второе', '03': 'третье', '04': 'четвёртое', '05': 'пятое',
